...
function Index() {
  ...
  return (
    ...
    >
      {/* Top nav */}
      <header className="flex items-center justify-between px-3 pt-4 pb-3" style={{ background: "linear-gradient(to bottom, var(--color-trade-card) 0%, color-mix(in oklch, var(--color-trade-card) 40%, transparent) 100%)" }}>
