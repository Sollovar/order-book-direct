  ...
  return (
    ...
    >
      <span
        ...
        style={{ backgroundColor: enabled ? "#f3d0a2" : "rgba(128,128,128,0.25)" }}
      />
      <span
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ color: active ? "#f3d0a2" : "var(--color-trade-text, white)", fontWeight: active ? 600 : 400 }}
                >
                  {lang}
                </span>
                {active && <Check className="h-4 w-4 flex-shrink-0" style={{ color: "#f3d0a2" }} />}
              </button>
            );
          })}
        </div>
