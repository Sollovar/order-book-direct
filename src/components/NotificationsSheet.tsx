...
> = {
  ...
  funding: { icon: Zap,          color: "#f3d0a2", bg: "rgba(243,208,162,0.12)" },
            ...
            <p className="text-[18px] font-bold text-trade-text leading-tight">
              ...
              {unreadCount > 0 && (
                <span className="ml-2 inline-flex items-center justify-center h-5 px-1.5 rounded-full text-[10px] font-bold text-black"
                  style={{ backgroundColor: "#f3d0a2", minWidth: 20 }}>
                  {unreadCount}
                </span>
              )}
            </p>
          ...
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              <div className="h-12 w-12 rounded-2xl flex items-center justify-center"
                style={{ backgroundColor: "rgba(243,208,162,0.10)" }}>
                <Bell className="h-5 w-5" style={{ color: "#f3d0a2" }} />
              </div>
            ...
            notifications.map((n) => {
              ...
              return (
                <div
                  ...
                  style={{ backgroundColor: n.unread ? "rgba(243,208,162,0.05)" : "transparent",
                           border: n.unread ? "1px solid rgba(243,208,162,0.12)" : "1px solid transparent" }}
                >
                  {/* Icon */}
                  <span
